"""Find the right alpha_max threshold for PVTOL shield-diff."""
import sys, os
...
from adaptive_clf.configs import AdaptiveConfig, CLFConfig, LyapunovConfig
...
print(f"{'alpha_max':>10s}  {'NaN?':>5s}  {'grad_norm':>12s}  {'loss':>10s}")
print("-" * 45)

for am in [0.5, 1.0, 2.0, 3.0, 5.0, 7.0, 10.0, 20.0, 50.0, 100.0, 0.0]:
    def loss_fn(params, alpha_max_val=am):
        phi = params["lyap_phi"]
    ...
    print(f"{am:10.1f}  {status:>5s}  {float(grad_norm):12.2f}  {float(loss):10.3f}")
